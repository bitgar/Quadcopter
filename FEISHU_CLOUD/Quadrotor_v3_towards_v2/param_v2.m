...
G_beta_dnr = tf([(Kpr*sin(alpha0)-Krr*cos(alpha0)),g/v0*(Kpr+Krr*tan(theta0))],[1 -a_beta 0 0])
...
G_beta_dna = tf([(Kpa*sin(alpha0)-Kra*cos(alpha0)),g/v0*(Kpa+Kra*tan(theta0))],[1 -a_beta 0 0])
disp('---------------------------------------------')
